...
from issues.emissions.emission_calculations import deduct_cement, calculate_municipality_budgets, calculate_paris_path, calculate_trend, calculate_change_percent, calculate_budget_runs_out
...
class TestChargingPointCalculations(unittest.TestCase):
    ...
    def test_calculate_change_percent(self):
        ...
        self.assertEqual(result_change_percent.iloc[0]['emissionChangePercent'], expected_change_percent)
    ...
    def test_calculate_budget_runs_out(self):
        ...
        df_result = calculate_budget_runs_out(df_input, LAST_YEAR_IN_SMHI_DATA)
        expected_date = datetime.date(2027, 4, 9)
        self.assertEqual(df_result.iloc[0]['budgetRunsOut'], expected_date)
