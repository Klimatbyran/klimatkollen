      ...
      <ContentWrapper>
        <TextSection>
          <HeaderSection>
            ...
            {toggleFirst ? (
              ...
              <ArrowDown className="arrow" onClick={() => setToggleFirst(!toggleFirst)} />
            )}
          </HeaderSection>
          {toggleFirst && (
            <ToggleSection>
              <Paragraph>
                ...
                delas i sociala kanaler och läsas i mobilen. Här kan du se hur det går med
                klimatutsläppen för Sverige som helhet och för enskilda kommuner. Du kan
                också se den mängd koldioxid vi har kvar att släppa ut enligt Parisavtalet
                och hur stort glappet är mellan målet och hur det faktiskt går. Du kan
                också se de största utsläppskällorna i din kommun och hur mycket (eller
                lite) utsläppen i din kommun minskar jämfört med andra.{' '}
              </Paragraph>
              <Paragraph>
              ...
              <Paragraph>
                All fakta på Klimatkollen kommer från offentliga källor. Vi redovisar alla
                källor tydligt så att du enkelt kan kolla upp och läsa mer. Om något
                blivit fel, mejla gärna oss på{' '}
                <a href="mailto:hej@klimatkollen.se">hej@klimatkollen.se</a> så att vi kan
                ändra.
              </Paragraph>
              <Paragraph>
                ...
                . Vi tror på kraften i att visualisera fakta på ett enkelt och tilltalande
        ...
        <TextSection>
          <HeaderSection>
            ...
            {toggleSecond ? (
              <ArrowUp className="arrow" onClick={() => setToggleSecond(!toggleSecond)} />
            ) : (
              <ArrowDown
                className="arrow"
          ...
          {toggleSecond && (
            <ToggleSection>
              <Paragraph>
                Parisavtalet är ett juridiskt bindande avtal mellan världens länder om att
                begränsa den globala uppvärmningen till väl under två grader med sikte på
                1,5 grader.
              </Paragraph>
              <Paragraph>
                För att nå målet måste världen som helhet halvera växthusgasutsläppen till
                2030 och nå nära noll utsläpp senast 2050.
              </Paragraph>
              <Paragraph>
                ...
                men också hjälpa mer sårbara länder att ställa om. I Sverige stöds
                Parisavtalet av alla partier i riksdagen.
              </Paragraph>
              <Paragraph>
        ...
        <TextSection>
          <HeaderSection>
            ...
            {toggleThird ? (
              ...
              <ArrowDown className="arrow" onClick={() => setToggleThird(!toggleThird)} />
            )}
          </HeaderSection>
          {toggleThird && (
            <ToggleSection>
              <Paragraph>
                ...
                vi riskerar att öka temperaturen så mycket att det bryter mot
                Parisavtalet. Det är ett sätt att åskådliggöra utsläppsutrymmet som finns
                kvar om vi ska hålla uppvärmningen under 1,5 grader. FN:s klimatpanel,
                IPCC, beräknar en global koldioxidbudget, som sedan kan brytas ner per
                land, region eller kommun. Klimatkollen visar koldioxidbudgetar för alla
                Sveriges kommuner som utgår ifrån Parisavtalets mål om 1,5 graders global
                uppvärmning.{' '}
              </Paragraph>
              <Paragraph>
        ...
        <FlexSection>
          ...
          <IconSection>
            <IconWrapper>
              <a href="https://www.wedonthavetime.org/" target="_blank" rel="noreferrer">
                <WeDontHaveTime />
              </a>
            </IconWrapper>
            <Paragraph>
              Världens största sociala nätverk för klimataktion. Skapa din egen kampanj på{' '}
              <a href="https://www.wedonthavetime.org/" target="_blank" rel="noreferrer">
          ...
          <IconSection>
            ...
            <Paragraph>
              Ett nätverk som arbetar för att klimatfrågan ska lyftas högst upp på agendan
            </Paragraph>
          </IconSection>
          <IconSection>
            <IconWrapper>
